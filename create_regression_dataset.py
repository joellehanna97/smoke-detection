...
weather_data = True  # If already downloaded, set to True
...
new_dir = 'images_subset/training'
...
# print(df_labels[df_labels.label == 'negative']['gen_output'].value_counts())
# print(df_labels[df_labels.label == 'positive']['gen_output'].value_counts())
# print(df_labels[(df_labels.label == 'positive') & (df_labels.gen_output <= 0)])
# print(df_labels.label.value_counts())
# print(df_labels.precipitation.value_counts())
# print(df_labels)
